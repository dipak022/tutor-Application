    ...
    <div class="site-width">
        ...
        <li class="dropdown">                 
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><i class="icon-book-open"></i>Teacher Permition </a>                               
                        <ul class="sub-menu">
            ...
            <li class="dropdown">                 
                <ul>
                    <li class="dropdown"><a href="#"><i class="icon-book-open"></i>Teacher Account</a>                               
                        <ul class="sub-menu">
                        <li><a href="{{route('teacher.create.account')}}"><i class="icon-lock"></i>Create Teacher Account</a></li> 
            ...
            <li class="dropdown">                 
                <ul>
                    <li class="dropdown"><a href="#"><i class="icon-book-open"></i>User Account</a>                               
                        <ul class="sub-menu">
...
<footer class="site-footer">
    ...
    Copyright © 2022 Sabbir Hassan iTs- All Rights Reserved. 
</footer>
<!-- END: Footer-->
        <!-- START: Back to top-->
