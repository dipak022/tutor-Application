    ...
    <div class="site-width">
        <nav class="navbar navbar-expand-lg  p-0">
            <div class="navbar-header  h-100 h4 mb-0 align-self-center logo-bar text-left">  
                <a href="{{ url('specialist/dashboard') }}" class="horizontal-logo text-left">
...
<div class="sidebar">
    <div class="site-width">
        ...
        <ul id="side-menu" class="sidebar-menu">
            ...
            <li class="dropdown">                 
                <ul>
                    <li class="dropdown"><a href="#"><i class="icon-book-open"></i>Update Profile</a>                               
                        <ul class="sub-menu">
                            <li><a href="{{route('update.profile')}}"><i class="icon-lock"></i> Update Profile</a></li>
            ...
            <li class="dropdown">                 
                <ul>
                    <li class="dropdown"><a href="#"><i class="icon-book-open"></i>Message </a>                               
                        <ul class="sub-menu">
                            <li><a href="{{route('farmer.message')}}"><i class="icon-lock"></i> Massage</a></li>
...
<footer class="site-footer">
    ...
    Copyright © 2021 Sabbir iTs- All Rights Reserved. 
</footer>
<!-- END: Footer-->
        <!-- START: Back to top-->
